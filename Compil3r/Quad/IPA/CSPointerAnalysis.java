// CSPointerAnalysis.java, created Jun 15, 2003 10:08:38 PM by joewhaley
 ...
 * 
 * @author John Whaley
 * @version $Id: CSPointerAnalysis.java,v 1.2 2003/07/07 10:36:36 joewhaley Exp $
 */
public class CSPointerAnalysis extends Solver {
    ...
    public CSPointerAnalysis(CallGraph cg) {
        this(cg, DEFAULT_NODE_COUNT, DEFAULT_CACHE_SIZE);
    }
    
    public CSPointerAnalysis(CallGraph cg, int nodeCount, int cacheSize) {
        this.cg = cg;
