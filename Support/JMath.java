/*
 * -------------------------------------------------------------------------
 *      $Id: JMath.java,v 1.1 2003/05/12 10:05:20 joewhaley Exp $
 * -------------------------------------------------------------------------
...
public final class JMath
{
        ...
        public static strictfp float min(float x, float y)
        {
                ...
                float ans = ((x <= y) ? x : y);
                if (ans == 0.0f &&
                        Float.floatToIntBits(y) == 0x80000000)
                                ans = y;
                return ans;
    }
        ...
        public static strictfp double max(double x, double y)
        {
                if (Double.isNaN(x))  return x;
                double ans = ((x >= y) ? x : y);
                if (x == 0.0  &&  y == 0.0  &&  Double.doubleToLongBits(x) == 0x8000000000000000L)
                        ans = y;
                return ans;
    }
    ...
    public static synchronized strictfp double random()
        ...
        public static double ceil(double x)
        {
                ...
                if (exp < 0) {
                        ...
                        if ((mask&ix) == 0)  return x;  // x is integral
                        if (x > 0.0)
        ...
        public static double IEEEremainder(double x, double p)
        {
                ...
                if (hp <= 0x7fdfffff)  x = x%(p+p);             /* now x < 2p */
